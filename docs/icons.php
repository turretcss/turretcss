	...
	<div class="container">
		<div class="page-header-content column-1">
			<div class="page-header-content-inner">
				...
				<p class="page-description">An outline of the SVG Icon Font library with utility classes for animations, lists, and icon display types.</p>
			</div>
		</div>
	</div>
</div>
...
<!-- Icons -->
<div class="panel">
	<h2 id="icons" class="section-title">Icon Utilites</h2>
	...
	<div class="alert alert-info"> CSS3 animations aren't supported in IE8 - IE9.<button type="button" class="alert-close" data-dismiss></button></div>
</div>
