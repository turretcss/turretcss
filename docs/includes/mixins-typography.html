<table class="table table-bordered table-block table-responsive">
	...
	<tbody>
		<tr>	
			<td><code>.font-family(@font-family, @font-weight);</code></td>
			<td>Quick utility to set <code>font-family</code> and <code>font-weight</code> values</td>
		</tr>
		<tr>	
			<td><code>.thin-font();</code></td>
			<td>Sets <code>font-family</code> and <code>font-weight</code> from values in <code>defintitions.less</code></td>
		</tr>
		<tr>	
